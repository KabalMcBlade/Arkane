...
bool VertexBufferObject::AllocBufferObject(const void* _data, size_t _allocSize, EBufferUsage _usage)
{
...
void VertexBufferObject::Reference(const VertexBufferObject& _other, size_t _refOffset, size_t _refSize)
{
	akAssertReturnVoid(!IsMapped(), "Buffer must be not mapped");
...
void VertexBufferObject::Update(const void* _data, size_t _size, size_t _offset /*= 0*/) const
{
