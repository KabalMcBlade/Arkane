...
bool UniformBufferObject::AllocBufferObject(const void* _data, size_t _allocSize, EBufferUsage _usage /*= EBufferUsage::EBufferUsage_Dynamic*/)
{
...
void UniformBufferObject::Reference(const UniformBufferObject& _other, size_t _refOffset, size_t _refSize)
{
	akAssertReturnVoid(!IsMapped(), "Buffer must be not mapped");
...
void UniformBufferObject::Update(const void* _data, size_t _size, size_t _offset /*= 0*/) const
{
